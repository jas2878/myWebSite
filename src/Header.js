...
const Header = () => {
  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <Link className="Introductiolisthome" to="/">
            홈{" "}
          </Link>
        </li>

        <li className="subNav Introductiolist Introductiolist1">
          <a className="Introductiolistmain" href="#none">
            회사소개
          </a>
          <ul className="subnavwrap">
            <li className="Introductiolist">
              <Link className="Introductiolistmain" to="/Introductio">
                회사소개
              </Link>
            </li>
            <li>
              <Link className="Introductiolistnews" to="/News">
                NEWS
              </Link>
            </li>
            <li>
        ...
        <li className="subNav">
          <Link to="/" className="solutionNav">
            솔루션
          </Link>
          <ul className="subnavwrap subnavwrapSolution">
            <li className="Introductiolist">
              <Link className="IntroductioSolution" to="/Solution">
                재난의사결정지원솔루션
              </Link>
            </li>
            <li className="Introductiolist">
              <Link className="IntroductioSimulation" to="/Simulation">
                시뮬레이션
              </Link>
            </li>
            <li className="Introductiolist">
              <Link className="IntroductioSafeinfo" to="/Safeinfo">
                안전대피로{" "}
              </Link>
            </li>
          </ul>
        ...
        <li>
          <a
            href="https://www.youtube.com/shorts/LdJV7Lzg-5Y?reload=9&feature=share"
            target="_blank"
            rel="noopener noreferrer"
          >
            시연영상
